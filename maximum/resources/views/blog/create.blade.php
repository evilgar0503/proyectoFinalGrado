<x-app-layout>
    <div class="bg-white h-fit pb-16 pt-12 lg:py-24  w-4/4 lg:w-3/4 lg:mx-auto">
        <div class=" mb-4 lg:mb-16">
            <div class="flex w-full justify-between h-fit">
                <h1 class="text-xl m-0 lg:m-5 flex items-center font-bold flex-nowrap">Creación noticia</h1>
                ...
                <div class=" w-fit">
                    <a href="{{ route('blog') }}" class="flex m-5 items-center hover:scale-105 transition duration-500">
                        ...
                        <span class="ml-2 lg:block hidden">Volver al blog</span>
                    </a>
                </div>
            </div>
            <hr>
        ...
        <form action="{{ route('noticia.create') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="lg:mx-36 mx-4 justify-center">
                <div>
                ...
                <div class="mt-2 lg:mt-5">
                    ...
                    <textarea name="cuerpo" id="tinymce" cols="30" rows="10"  class="w-full"></textarea>
                </div>
                <div class="my-2 lg:mt-5">
                    <h2 class="text-xl mb-3">Portada</h2>
                    <input type="file" id="imagen" name="imagen">
                </div>
                <input type="submit" value="Crear" class="float-right buttonGeneral py-3 px-8">
            </div>
