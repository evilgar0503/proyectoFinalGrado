    ...
    <div class="border border-blue-500 modal-container my-4 lg:my-16 bg-white  mx-4 lg:mx-auto w-full lg:w-7/12 rounded-xl shadow-lg z-50 overflow-y-scroll"
        ...
        <div class=" py-4 text-left px-4">
            ...
            <div class="flex justify-between items-center pb-3">
                <p class="text-xl font-bold text-gray-500">Crear Producto</p>
                <div class="modal-close cursor-pointer z-50" wire:click="cerrarModal('modalCreateProduct')">
                ...
                <form wire:submit.prevent="crearProducto" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="">
                            ...
                            <input type="text" id="nombre" autocomplete="off" name="nombre" wire:model='nombre'
                                value="{{ old('nombre') }}"
                        ...
                        <div class="">
                            ...
                            <textarea id="tinymce1" rows="4" name="descripcion" wire:model='descripcion'
                                class="py-3 pl-2 w-full text-xs border-2 border-gray-300 rounded-md" placeholder="Descripción del producto...">{{ old('descripcion') }}</textarea>
                        ...
                        <div class="">
                            ...
                            <textarea id="tinymce2" rows="4" name="ingredientes" wire:model='ingredientes'
                                class="py-3 pl-2 w-full text-xs border-2 border-gray-300 rounded-md" placeholder="Ingredientes del producto...">{{ old('ingredientes') }}</textarea>
                        ...
                        <div class="">
                            ...
                            <textarea id="tinymce3" rows="4" name="instrucciones" wire:model='instrucciones'
                                class="py-3 pl-2 w-full text-xs border-2 border-gray-300 rounded-md" placeholder="Instrucciones del producto...">{{ old('instrucciones') }}</textarea>
                        ...
                        <div class="flex flex-row gap-4">
                            <div class="w-1/2">
                                ...
                                <input type="text" id="marca" autocomplete="off" name="marca"
                                    wire:model='marca' value="{{ old('marca') }}"
                            ...
                            <div class="w-1/2">
                                ...
                                <input type="text" id="sabor" autocomplete="off" name="sabor"
                                    wire:model='sabor' value="{{ old('sabor') }}"
                                    class="h-3 py-3 pl-2 w-full border-2 text-xs border-gray-300  rounded-md"
                        ...
                        <div class="flex flex-row gap-4">
                            ...
                            <div class="w-1/2">
                                ...
                                <input type="text" id="peso" autocomplete="off" name="peso"
                                    wire:model='peso' value="{{ old('peso') }}"
                                    class="h-3 py-3 pl-2 w-full border-2 text-xs border-gray-300  rounded-md"
                                    placeholder="Sabor del producto...">
                        ...
                        <div class="flex flex-col lg:flex-row gap-4">
                            <div>
                                ...
                                <input type="number" min="0.00" step="0.01" id="precio"
                                    autocomplete="off" name="precio" value="{{ old('precio', 0) }}"
                                    wire:model='precio'
                                    class="h-3 py-3 pl-2 w-full border-2 text-xs border-gray-300  rounded-md">
                            ...
                            <div>
                                <label for="precio_empresa" class="text-sm text-black font-semibold">Precio
                                    Empresa</label>
                                <input type="number" value="{{ old('precio_empresa', 0) }}" min="0.00"
                            ...
                            <div>
                                <label for="precio_descuento" class="text-sm text-black font-semibold">Precio
                                    Descuento</label>
                                <input type="number" value="{{ old('precio_descuento', 0) }}" min="0.00"
                        ...
                        <div class="flex flex-col lg:flex-row gap-4">
                            ...
                            <div class="w-full lg:w-1/2">
                                ...
                                <select name="estado_producto" id="estado_producto" wire:model='estado'
                                    ...
                                    <option value="desactivado" >Desactivado
                                    </option>
                                </select>
                        ...
                        <div class="w-full">
                            <div class="w-full">
                                ...
                                <input type="file" id="imagen" name="imagen" wire:model='imagen'
                                    class="py-3 pl-2 w-full border-2 text-xs border-gray-300 rounded-md">
                                <x-input-error :messages="$errors->get('imagen')" class="mt-2" />
                            </div>
                        </div>
                    </div>
                    <div class="flex justify-end pt-2 space-x-14">
                        <input wire:click="createProduct()" class="px-4 text-center py-3 buttonGeneral cursor-pointer" value="Crear">
                    </div>
                </form>
            </div>
            <!--Footer-->
