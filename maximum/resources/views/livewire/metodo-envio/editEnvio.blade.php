    ...
    <div class="border border-blue-500 modal-container my-4 lg:my-16 bg-white  mx-4 lg:mx-auto w-full lg:w-7/12 rounded-xl shadow-lg z-50 overflow-y-scroll"
        ...
        <div class=" py-4 text-left px-4">
            ...
            <div class="flex justify-between items-center pb-3">
                <p class="text-xl font-bold text-gray-500">Editar Método Envío</p>
                <div class="modal-close cursor-pointer z-50" wire:click="cerrarModal('modalEditMetodo')">
            ...
            <div class="my-3 mx-1 lg:mx-4 flex flex-col justify-center gap-8">
                <form wire:submit.prevent="" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-end pt-2 space-x-14">
                        <input wire:click="editMetodo()" class="px-4 text-center py-3 buttonGeneral cursor-pointer"
                            value="Editar">
                    </div>
                </form>
            </div>
