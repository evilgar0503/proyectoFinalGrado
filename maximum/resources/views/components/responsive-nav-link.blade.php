...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-indigo-400 text-left text-base font-medium bg-indigo-50 focus:outline-none focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out'
