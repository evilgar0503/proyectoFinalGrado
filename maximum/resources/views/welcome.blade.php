<x-app-layout>
    ...
    <div class="h-screen flex">
        <div class="h-3/5 w-full text-white p-16 form-back">
            <div class="flex justify-start my-16">
                ...
                <span class="ml-6 font-bold">UBICACIÓN<span>
                        <br>
                        <span class="font-normal">C. Gaspar de Montellano, 14800 Priego de Córdoba, Córdoba</span>
            </div>
            <div class="flex justify-start my-16">
        ...
        <div class=" w-2/5 mr-24 ml-auto form rounded ">
            ...
            <div class="p-16">
                ...
                <div class="w-100 mt-8">
                    ...
                    <div class="form__group field mt-6">
                        <textarea type="input" class="form__field" placeholder="Asunto" name="asunto" id='asunto' required
                            style="resize: none;" rows="3"></textarea>
                        <label for="name" class="form__label">Cuerpo</label>
                    </div>
                    <div class="flex justify-end mb-14 w-full">
                        <a href="#">
                            <div class="btn-us w-50 font-semibold uppercase py-4 px-8 rounded">
                                <span class="btn-us-text">Enviar</span>
                            </div>
                        </a>
                    </div>
