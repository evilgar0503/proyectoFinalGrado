    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="md:flex md:justify-around">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase ">Maximum</h2>
                    <ul class="text-white  font-medium">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">¿Quienes somos?</a>
                        </li>
                        <li>
                            <a href="https://tailwindcss.com/" class="hover:underline">Nuestra Tienda</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-white font-medium">
                        <li class="mb-4">
                            <a href="{{route('contacto')}}" class="hover:underline ">Formulario</a>
                        </li>
                        <li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center">© 2023 <a href="https://flowbite.com/"
                    class="hover:underline">Pricampo</a>. All Rights Reserved.
            </span>
